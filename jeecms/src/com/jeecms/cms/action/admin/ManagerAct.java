...
{
	@RequiresPermissions("manager:manager_main")
	@RequestMapping("/manager/manager_main.do")
	public String manager(HttpServletRequest request, ModelMap model)
	{
		return "manager/manager_main";
	}

	@RequiresPermissions("manager:manager_left")
	@RequestMapping("/manager/manager_left.do")
	public String managerLeft(HttpServletRequest request, ModelMap model)
	{
		return "manager/manager_left";
	}
	...
	public String goCheck(Integer ids, HttpServletRequest request, ModelMap model)
	{
		...
		{
			return "manager/manager_go_checkOut";
		}
