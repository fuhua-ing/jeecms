...
public class LoginAct
{
	...
	public static final String TPL_LOGIN = "tpl.login_html";
	...
	@RequestMapping(value = "/login_html.jspx")
	public String csis(HttpServletRequest request, ModelMap model)
	{
		CmsSite site = CmsUtils.getSite(request);
		// 将request中所有参数
		model.putAll(RequestUtils.getQueryParams(request));
		FrontUtils.frontData(request, model, site);
		return FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_CSI, TPL_LOGIN);
	}
