...
public abstract class BaseCmsUserExt implements Serializable
{
	...
	public static String PROP_GRADUATE = "graduate";
	public static String PROP_COMPANY_NAME = "companyName";
	public static String PROP_COMPANY_TYPE = "companyType";
	public static String PROP_COMPANY_ADDRESS_PROVINCE = "companyAddressProvince";
	public static String PROP_COMPANY_ADDRESS_CITY = "companyAddressCity";
	public static String PROP__PROVINCE_NAME = "provinceName";
	public static String PROP__CITY_NAME = "cityName";
	public static String PROP_COMPANY_ADDRESS_DETAIL = "companyAddressDetail";
	public static String PROP_COMPANY_INTRO = "companyIntro";
	public static String PROP_COMPANY_POSITION = "companyPosition";
	...
	public boolean equals(Object obj)
	{
		if (null == obj)
			return false;
		if (!(obj instanceof com.jeecms.core.entity.CmsUserExt))
			return false;
		else
		{
			com.jeecms.core.entity.CmsUserExt cmsUserExt = (com.jeecms.core.entity.CmsUserExt) obj;
			if (null == this.getId() || null == cmsUserExt.getId())
				return false;
			else
				return (this.getId().equals(cmsUserExt.getId()));
		}
	}
