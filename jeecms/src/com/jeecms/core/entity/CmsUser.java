...
public class CmsUser extends BaseCmsUser implements PriorityInterface
{
	 ...
	 */
	public CmsUser(java.lang.Integer id, com.jeecms.core.entity.CmsGroup group, java.lang.String username,
			...
			java.lang.Boolean viewonlyAdmin, java.lang.Boolean selfAdmin, java.lang.Boolean disabled)
	{
		...
		super(id, group, username, registerTime, registerIp, loginCount, rank, uploadTotal, uploadSize, admin,
				viewonlyAdmin, selfAdmin, disabled);
	}
